...
if __name__ == '__main__':
    ...
    '''
    tfidfspace_path = "./work1/tfidfspace.txt"  # 将TF-IDF词向量保存为txt，方便查看
    tfidfspace_arr_path = "./work1/tfidfspace_arr.txt"  # 将TF-IDF词频矩阵保存为txt，方便查看
    tfidfspace_vocabulary_path = "./work1/tfidfspace_vocabulary.txt"  # 将分词的词汇统计信息保存为txt，方便查看
    testSpace_path = "./work1/testSpace.txt"  # 测试集分词信息
    testSpace_arr_path = "./work1/testSpace_arr.txt"  # 测试集词频矩阵信息
    trainbunch_vocabulary_path = "./work1/trainbunch_vocabulary.txt"  # 所有分词词频信息
    tfidfspace_out_arr_path = "./work1/tfidfspace_out_arr.txt"  # tfidf输出矩阵信息
    tfidfspace_out_word_path = "./work1/tfidfspace_out_word.txt"  # 单词形式的txt
    testspace_out_arr_path = "./work1/testspace_out_arr.txt"  # 测试集输出矩阵信息
    testspace_out_word_apth = "./work1/testspace_out_word.txt"  # 测试界单词信息
    '''
    ...
    bayesAlgorithm(tfidfspace_dat_path,
                   ...
                   testspace_out_word_apth)  #结果输出展示